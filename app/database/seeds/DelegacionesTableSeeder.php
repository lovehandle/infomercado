...
class DelegacionesTableSeeder extends Seeder {
	...
	public function run()
	{
        ...
        DB::table('delegaciones')->insert(array(
            ...
            array('numero' => '4', 'nombre' => 'Coyoacán', 'route'=>'coyoacan','siglas'=>'COY','created_at'=>'2014-04-04','updated_at'=>'2014-04-04'),
            array('numero' => '5', 'nombre' => 'Cuajimalpa', 'route'=>'cuajimalpa','siglas'=>'CUJ','created_at'=>'2014-04-04','updated_at'=>'2014-04-04'),
